...
namespace elearning_b1.Migrations
{
    ...
    [Migration("20241204132348_chuc nang noi")]
    partial class chucnangnoi
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("elearning_b1.Models.WritingCorrection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("WritingCorrections");
                });

            modelBuilder.Entity("elearning_b1.Models.WritingTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("elearning_b1.Models.WritingCorrection", b =>
                {
                    b.HasOne("elearning_b1.Models.WritingTask", "WritingTask")
                        .WithMany()
            ...
            modelBuilder.Entity("elearning_b1.Models.WritingTask", b =>
                {
                    b.HasOne("elearning_b1.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
